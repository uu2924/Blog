...
public class UserApiController {
	...
	public ResponseDTO<String> login(@RequestBody BlogUser requestUser) {
		System.out.println("UserApiController: login:"+requestUser);
		String token = userSerivce.loginMember(requestUser);
		return new ResponseDTO<String>(HttpStatus.OK.value(), token);
	}
}
